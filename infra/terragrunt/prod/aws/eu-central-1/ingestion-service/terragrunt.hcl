...
dependency "ecs_cluster" {
  ...
  mock_outputs = {
    ...
    log_group_names = {
      ingestion = "/aws/ecs/todo-list-prod/ingestion"
    }
    execution_role_arns = {
      ingestion = "arn:aws:iam::000000000000:role/todo-list-prod-ingestion-exec"
    }
    task_role_arns = {
      ingestion = "arn:aws:iam::000000000000:role/todo-list-prod-ingestion-task"
    }
    task_role_names = {
      ingestion = "todo-list-prod-ingestion-task"
    }
  }
}
