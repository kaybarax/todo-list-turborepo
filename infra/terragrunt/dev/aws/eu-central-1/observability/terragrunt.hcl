...
dependency "alb" {
  ...
  mock_outputs = {
    alb_arn_suffix              = "app/todo-list-dev-api/0000000000000000"
    api_target_group_arn_suffix = "targetgroup/todo-list-dev-api/0000000000000000"
  }
}
...
dependency "api_service" {
  ...
  mock_outputs_allowed_terraform_commands = ["init", "validate", "plan"]
  mock_outputs = {
    service_name = "todo-list-dev-api"
  }
}
...
dependency "ingestion_service" {
  ...
  mock_outputs_allowed_terraform_commands = ["init", "validate", "plan"]
  mock_outputs = {
    service_name = "todo-list-dev-ingestion"
  }
}
...
dependency "database" {
  ...
  mock_outputs_allowed_terraform_commands = ["init", "validate", "plan"]
  mock_outputs = {
    cluster_identifier = "todo-list-dev-docdb"
  }
}
...
dependency "redis" {
  ...
  mock_outputs_allowed_terraform_commands = ["init", "validate", "plan"]
  mock_outputs = {
    replication_group_id = "todo-list-dev-redis"
  }
}
