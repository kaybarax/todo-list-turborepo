...
dependency "ecs_cluster" {
  ...
  mock_outputs = {
    ...
    log_group_names = {
      ingestion = "/aws/ecs/todo-list-dev/ingestion"
    }
    execution_role_arns = {
      ingestion = "arn:aws:iam::000000000000:role/todo-list-dev-ingestion-exec"
    }
    task_role_arns = {
      ingestion = "arn:aws:iam::000000000000:role/todo-list-dev-ingestion-task"
    }
    task_role_names = {
      ingestion = "todo-list-dev-ingestion-task"
    }
  }
}
