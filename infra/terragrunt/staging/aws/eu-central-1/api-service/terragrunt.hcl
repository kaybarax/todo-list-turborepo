...
dependency "ecs_cluster" {
  ...
  mock_outputs = {
    ...
    log_group_names = {
      api = "/aws/ecs/todo-list-staging/api"
    }
    execution_role_arns = {
      api = "arn:aws:iam::000000000000:role/todo-list-staging-api-exec"
    }
    task_role_arns = {
      api = "arn:aws:iam::000000000000:role/todo-list-staging-api-task"
    }
    task_role_names = {
      api = "todo-list-staging-api-task"
    }
  }
}
...
dependency "alb" {
  ...
  mock_outputs_allowed_terraform_commands = ["init", "validate", "plan"]
  mock_outputs = {
    api_target_group_arn = "arn:aws:elasticloadbalancing:eu-central-1:000000000000:targetgroup/todo-list-staging-api/0000000000000000"
